...
MainWindow::MainWindow(QWidget *parent): QMainWindow(parent), ui(new Ui::MainWindow){
    ...
    listaDeCores << Qt::cyan << Qt::magenta << Qt::green << Qt::red
                 << Qt::lightGray << QColor(255, 165, 0) /*Laranja*/ << Qt::blue;
    indiceCorAtual = 0;
...
void MainWindow::on_btn_atualizar_visualizacao_clicked(){
    ...
    ui->Frame->setVisualizacao(Ponto4D(wc_x, wc_y, wc_z), zoom, rotX, rotY, rotZ);
}

void MainWindow::resetarPaineisDeVisualizacao(){
    ui->caixa_wc_x->setValue(0.0);
    ui->caixa_wc_y->setValue(0.0);
    ui->caixa_wc_z->setValue(0.0); // Câmera Z=0 (original)
